...
Renderer::Renderer(GLFWwindow* window) : GLFWBase(window) {
...
void Renderer::render() {
    ...
    // make orthographic transformation
    // bottom left corner of window is (0. 0)
    // top right corner of window is (width, height) of window
